...
class QuantAI(object):
    ...
    def __init__(self, param_dict, debug = False):
        ...
        self.pipeline, self.n_factors = get_pipeline(param_dict["pipeline"])
        ...
        # may be able to store these in strategy instead
        self.prices = {}
        self.risk_values = {}

        # get the agent
        self.agent = initialize_agent(param_dict)
    ...
    def initialize_agent(self, param_dict):
        ...
        agent_params = {}
        agent_params["n_securities"] = param_dict["n_securities"]
        agent_params["n_factors"] = param_dict["n_factors"]
        agent_params["lr"] = param_dict["lr"]
        agent_params["batch_size"] = param_dict["batch_size"]
